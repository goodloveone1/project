...
if($permiss_id==2){
	...
	AND amt6.leader_comt != 0 AND amt6.supervisor_comt != 0 AND y.y_year BETWEEN $yeadb10 AND $yeadnow
...
if($permiss_id==3){
	...
	INNER JOIN asessment_t6 AS amt6 ON am.ass_id = amt6.ass_id
	WHERE  am.staff='$st_id' AND  am.ass_id LIKE  'TOR%' AND  amt5.accept = 1 AND amt5.inform = 1 
	AND amt6.leader_comt != 0  AND y.y_year BETWEEN $yeadb10 AND $yeadnow") or  die("SQL Error1==>1".mysqli_error($con));
...
if($permiss_id==4){
	...
	INNER JOIN sum_score_assessment_t3 AS sumt3 ON am.ass_id = sumt3.ass_id
	INNER JOIN asessment_t5 AS amt5 ON am.ass_id = amt5.ass_id
	WHERE  am.staff='$st_id' AND  am.ass_id LIKE  'TOR%' AND  amt5.accept = 1 AND amt5.inform = 1  AND y.y_year BETWEEN $yeadb10 AND $yeadnow
	 ") or  die("SQL Error1==>1".mysqli_error($con));
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "รายงานผลการประเมิน 10 ปีย้อนหลัง"
	},	
	axisY: {
