...
<form id="foreditbrc">
 <div class="modal fade" id="checksub" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header headtitle">
                    <h5 class="modal-title" id="exampleModalLabel">รายละเอียดการปฏิบัติงาน </h5>
                ...
                <?php  for($i=0;$i<count($set);$i++){
                    ...
                    <div class="col-md form-group row" >
                       ...
                       <input readonly type="number" min='0' max='999'  class="form-control col-sm"   name="i_no<?php echo $i+1 ?>" size=3 value="<?php echo $set[$i]['ab_num'] ?>"><label class="col-sm-1 col-form-label" > ครั้ง</label>
                       <input readonly type="number" min='0' max='999'    class="form-control col-sm"   name="i_day<?php echo $i+1 ?>" size=3 value="<?php echo $set[$i]['abl_day'] ?>"><label class="col-sm-1 col-form-label" > วัน</label>
                ...
                ?>
			    <input class="custom-control-input" type="checkbox" disabled value="1" id="customCheckbox" name="chk" <?php echo $action ?> >
			    <label class="custom-control-label" for="customCheckbox" readonly>
