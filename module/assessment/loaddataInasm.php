          ...
          if(empty($evd_id)){
            ...
            if($evd_status ==1){
              ...
              if($inform == 0 && $accept == 0){
                ...
                echo "<td class='text-center'><a href='javascript:void(0)' class='showevd text-success'  data-evdid='$evd_id' data-fullname='$fullname' title='คลิกเพื่อแสดงหลักฐาน'><i class='fas fa-check-circle fa-2x'></i><br>แสดงหลักฐาน</a></td>";
