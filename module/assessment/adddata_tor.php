...
$sql = "INSERT INTO  assessments (ass_id,staff,year_id,leader,sumwork,punishment)VALUES('$tor_id','$_SESSION[user_id]','$_POST[a_no]','$_POST[leader_id]','$_POST[sum_work]','$_POST[punishment]')";
//echo $sql;
