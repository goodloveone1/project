<?php
    ...
    $se_staff=mysqli_query($con,"SELECT prefix,fname,lname FROM staffs WHERE st_id='$staff_id'");
    list($prefix,$fname,$lname)=mysqli_fetch_row($se_staff)or die("SQL.error".mysqli_error($con));
...
<div class="row">
  ...
  <p>
	...
	$sql="SELECT  prefix,lname,fname,position FROM staffs WHERE st_id ='$staff_id'";
