...
$sum_id = mysqli_query($con,"SELECT COUNT(st_id) FROM staffs") or die ("mysql error=>>".mysql_error($con));
list($sumID) = mysqli_fetch_row($sum_id);
$gen_id=$y_id.$m.$min.$sumID+1;



$sql = "INSERT INTO staffs (st_id,user,pwd,branch_id,code,prefix,fname,lname,salary,acadeic,levels,startdate,permiss_id,position,picture) VALUES ('$gen_id','".$_POST['uname']."','".$_POST['passwd']."','".$_POST['suj']."','".$_POST['codeid']."','".$_POST['titlename']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['salary']."','".$_POST['ap']."','','".$_POST['startwork']."','".$_POST['permiss']."','".$_POST['pos']."','".$imgname."')";
